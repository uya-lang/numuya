...
- NumUya commit：`bba2b7af2be1e8c9b097c3146e330dec134f8958`
...
| --- | --- | --- | --- | --- | --- | --- |
| add | float64 | 1000000 | ok | 92809319.73 | missing | 0.02 |
| matmul | float64 | 512x512 | missing | missing | missing | missing |
| mul | float64 | 1000000 | ok | 80313481.1 | missing | 0.02 |
| random | float64 | 1000000 | missing | missing | missing | missing |
| sum | float64 | 1000000 | ok | 33221150.76 | missing | 0.01 |
...
| operation | dtype | shape | status | ns_per_iter | throughput | speedup_vs_numpy_cpu |
| --- | --- | --- | --- | --- | --- | --- |
| add | float32 | 1000000 | ok | 1928057.77 | missing | missing |
| add | float64 | 1000000 | ok | 1968205.99 | missing | 0.8 |
| matmul | float64 | 512x512 | missing | missing | missing | missing |
| mul | float64 | 1000000 | missing | missing | missing | missing |
| random | float64 | 1000000 | missing | missing | missing | missing |
| sum | float32 | 1000000 | ok | 1923441.63 | missing | missing |
| sum | float64 | 1000000 | ok | 1947554.62 | missing | 0.21 |
| transfer_d2h | float64 | 1000000 | ok | 916920.08 | missing | missing |
| transfer_h2d | float64 | 1000000 | ok | 972250.76 | missing | missing |

### CUDA kernel-only

| operation | dtype | shape | status | ns_per_iter | throughput | speedup_vs_numpy_cpu |
| --- | --- | --- | --- | --- | --- | --- |
| add | float32 | 1000000 | ok | 38886.93 | missing | missing |
| add | float64 | 1000000 | ok | 79035.15 | missing | 19.85 |
| matmul | float32 | 1024x1024 | ok | 1708660.4 | missing | missing |
| matmul | float32 | 2048x2048 | ok | 13913944.5 | missing | missing |
| matmul | float64 | 512x512 | missing | missing | missing | missing |
| matmul_vendor_tf32 | float32 | 2048x2048 | ok | 1513534.6 | missing | missing |
| mul | float64 | 1000000 | missing | missing | missing | missing |
| random | float32 | 1000000 | ok | 26634.65 | missing | missing |
| random | float64 | 1000000 | missing | missing | missing | missing |
| sum | float32 | 1000000 | ok | 34270.79 | missing | missing |
| sum | float64 | 1000000 | ok | 58383.78 | missing | 7.09 |
